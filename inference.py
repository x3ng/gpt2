...
# %% ===================== VAR ====================
MODEL_PATH = f"{BASE_DIR}/gpt2-117m-final"
...
model = AutoModelForCausalLM.from_pretrained(
    MODEL_PATH,
    torch_dtype=torch.float16 if torch.cuda.is_available() else torch.float32, # 推理时可用半精度加速
...
# %tensorboard --logdir ./gpt2-117m-scratch/logs
